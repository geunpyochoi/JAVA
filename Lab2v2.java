...
public class Lab2v2 {
	...
	public double circle_Area(double r) {
		...
		return ((r * r * PI)*100)/100;  // return the area of the circle of radius "r
	}
	...
	public Time2 time_Transform(int t) {
		...
		et.day = t / (60 * 60 * 24);
		et.hour = (t - et.day * 60 * 60 * 24) / (60 * 60);
		et.minute = (t - et.day * 60 * 60 * 24 - et.hour * 3600) / 60;
		et.second = t % 60;
	...
	public boolean inner_Range(int low, int high, int test_value) {
		boolean res;
		if (low < test_value && test_value < high)
			res = true;
		else
			res = false;
		return res;
